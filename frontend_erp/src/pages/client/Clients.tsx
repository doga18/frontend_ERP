...
const Clients = () => {
  ...
  const openWhatsApp = (numero: string, nomeAtendente: string, nameCliente: string) => {
    const nomeAtendenteCapitalized = nomeAtendente.charAt(0).toUpperCase() + nomeAtendente.slice(1);
    const nomeClienteCapitalized = nameCliente.charAt(0).toUpperCase() + nameCliente.slice(1);
                  ...
                  <tr key={client.clientId} className="hover:bg-gray-200 cursor-pointer">
                    ...
                    <td className="py-2 px-4 border-b">
                      <div
                        ...
                        onClick={() => openWhatsApp(client.contact, nameAtendente, client.name)}
