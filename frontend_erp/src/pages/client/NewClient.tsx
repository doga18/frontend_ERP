...
import { /*PhotoIcon, UserCircleIcon,*/ UserPlusIcon, LockClosedIcon, LockOpenIcon } from '@heroicons/react/24/outline'
...
import { newClient } from '../../slices/clientesSlice';
...
const NewClient = ( { isOpen, onClose }: Props) => {
  // Usestates
  ...
  // Selectors
  const { loading, /*errors: errorsClient,*/ updated: updatedClient } = useSelector((state: RootState) => state.client);
  ...
  console.log('resultado do cep: ', cepForm);
  console.log('Se existir erros serão mostrados: ', errorsForm);
                ...
                <form onSubmit={handleSubmit}>
                  <div className="space-y-12">
                    <div className="border-b border-gray-900/10 pb-12">
                      <h2 className="text-base/7 font-semibold text-gray-900">Novo usuário <UserPlusIcon className="w-5 h-5 inline-block ml-2"/></h2>
