      ...
      {!auth && (
        <div>
          <div className="forbidden">
            ...
            <p className="text-white">Ops ocorreu um erro, essa página requer autenticação.</p>
            <button className="btn" onClick={handleGoLogin}>Tente realizar um novo Loguin</button>
          </div>
        </div>
      )}
    </>
